...
namespace CSharpOctree {
    ...
    public class OctreeNode
    {
        ...
        public OctreeNode(double x_min, double x_max, double y_min, double y_max, double z_min, double z_max, double w_min, double w_max, int capacity)
        {
            this._bounds = new OctreeBounds(x_min, x_max, y_min, y_max, z_min, z_max, w_min, w_max);
        ...
        private bool _divide()
        {
            ...
            double _size_w = (this._bounds.getWMax() - this._bounds.getWMin()) / 2;
            ...
            this._bounds.getWMin(), this._bounds.getWMax() - _size_w,
            this._capacity);
            ...
            this._childs[8] = new OctreeNode(
                this._bounds.getXMin(), this._bounds.getXMax() - _size_x,
                this._bounds.getYMin(), this._bounds.getYMax() - _size_y,
                this._bounds.getZMin(), this._bounds.getZMax() - _size_z,
                this._bounds.getWMin() + _size_w, this._bounds.getWMax(),
                this._capacity);
            
            this._childs[9] = new OctreeNode(
                this._bounds.getXMin() + _size_x, this._bounds.getXMax(),
                this._bounds.getYMin(), this._bounds.getYMax() - _size_y,
                this._bounds.getZMin(), this._bounds.getZMax() - _size_z,
                this._bounds.getWMin() + _size_w, this._bounds.getWMax(),
            ...
            this._childs[10] = new OctreeNode(
                this._bounds.getXMin(), this._bounds.getXMax() - _size_x,
                this._bounds.getYMin() + _size_y, this._bounds.getYMax(),
                this._bounds.getZMin(), this._bounds.getZMax() - _size_z,
                this._bounds.getWMin() + _size_w, this._bounds.getWMax(),
            ...
            this._childs[11] = new OctreeNode(
                this._bounds.getXMin(), this._bounds.getXMax() - _size_x,
                this._bounds.getYMin(), this._bounds.getYMax() - _size_y,
                this._bounds.getZMin() + _size_z, this._bounds.getZMax(),
                this._bounds.getWMin() + _size_w, this._bounds.getWMax(),
            ...
            this._childs[12] = new OctreeNode(
                this._bounds.getXMin() + _size_x, this._bounds.getXMax(),
                this._bounds.getYMin(), this._bounds.getYMax() - _size_y,
                this._bounds.getZMin() + _size_z, this._bounds.getZMax(),
                this._bounds.getWMin() + _size_w, this._bounds.getWMax(),
            ...
            this._childs[13] = new OctreeNode(
                this._bounds.getXMin(), this._bounds.getXMax() - _size_x,
                this._bounds.getYMin() + _size_y, this._bounds.getYMax(),
                this._bounds.getZMin() + _size_z, this._bounds.getZMax(),
                this._bounds.getWMin() + _size_w, this._bounds.getWMax(),
            ...
            this._childs[14] = new OctreeNode(
                this._bounds.getXMin() + _size_x, this._bounds.getXMax(),
                this._bounds.getYMin() + _size_y, this._bounds.getYMax(),
                this._bounds.getZMin(), this._bounds.getZMax() - _size_z,
                this._bounds.getWMin() + _size_w, this._bounds.getWMax(),
            ...
            this._childs[15] = new OctreeNode(
                this._bounds.getXMin() + _size_x, this._bounds.getXMax(),
                this._bounds.getYMin() + _size_y, this._bounds.getYMax(),
                this._bounds.getZMin() + _size_z, this._bounds.getZMax(),
                this._bounds.getWMin() + _size_w, this._bounds.getWMax(),
        ...
        public bool AddLeaf(double x, double y, double z, double w, object obj)
        {
            if (!this._bounds.InBound(x, y, z, w))
            {
                return false;
            }
            ...
            if (this._innerNode)
            {
                for (int i = 0; i < 16; i++)
                {
                    if (this._childs[i].AddLeaf(x, y, z, w, obj))
                    {
                        break;
                    }
                }
            ...
            {
                this._leafs.Add(new OctreeLeaf(x, y, z, w, obj));
            }
